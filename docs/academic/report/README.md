...
Este directorio es un espacio de trabajo académico. El documento oficial y final se mantiene externamente por el equipo; los archivos Markdown ayudan a construir, revisar y conservar contenido respaldado.

La estructura vigente se basa inicialmente en la plantilla disponible, pero las instrucciones posteriores del profesor tienen prioridad. Si cambian, adapte `REPORT_DRAFT.md`.
